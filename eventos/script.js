...
function cargarProductos() {
    productos.push(new Manga(1, 'Dragon Ball Super V1', 1230.99, './img/manga2'));
    productos.push(new Manga(2, 'Dragon Ball Super V2', 1256.96, './img/wedding_cake.jpg'));
    productos.push(new Manga(3, 'Dragon Ball Super V3', 490.23, './img/brownie.jpg'));
}

function cargarCarrito() {
    let elementoCarrito = new ElementoCarrito(
        new Manga(1, 'Muffin', 1.99, './img/muffin.jpg'),
        1
    );
